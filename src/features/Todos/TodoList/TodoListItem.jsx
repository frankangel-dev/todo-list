...
export default function TodoListItem({todo, onCompleteTodo, onUpdateTodo, onDeleteTodo}) {
    ...
    return (
        <div className={`group flex items-center gap-2 transition-all duration-150 hover:-translate-y-0.5 hover:shadow-md`}>
            <div className={'relative flex-1 overflow-hidden rounded-2xl border border-border cursor-pointer'}>
