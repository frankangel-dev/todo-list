...
export default function TodoListItem({todo, onCompleteTodo, onUpdateTodo, onDeleteTodo}) {
    ...
    return (
        <div className={`group relative cursor-pointer overflow-hidden rounded-2xl border border-border transition-all duration-150 hover:-translate-y-0.5 hover:shadow-md`}>
            ...
            <li className={`flex items-center rounded-2xl px-5 py-4 ${swipePosition < 0 ? 'bg-surface' : 'bg-glass backdrop-blur-md'}`}
            ...
            >
                {isEditing ? (
                    ...
                    <>
                        ...
                        <button
                            className={`${todo.isCompleted ? 'border-accent bg-accent' : 'border-border bg-transparent'} h-9 w-9 shrink-0 cursor-pointer rounded-full border-2 transition-all duration-150 hover:bg-accent/50`}
                            type={'button'}
                        ...
                        <button
                            className={'ml-4 hidden cursor-pointer rounded-full border border-error p-2 text-error hover:bg-error/30 md:block md:opacity-0 md:transition-opacity md:duration-150 md:group-hover:opacity-100'}
                            type={'button'}
